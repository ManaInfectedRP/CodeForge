...
import type { Challenge, ChallengeDifficulty } from '@/lib/content';
...
type ChallengeCard = Pick<Challenge, 'slug' | 'title' | 'difficulty' | 'languages'>;

export function ChallengesBrowser({ challenges }: { challenges: ChallengeCard[] }) {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10">
      ...
      <p className="mt-2 text-slate-400">Solve problems in your browser, in the language of your choice.</p>
      ...
      {visible.length === 0 && <p className="mt-8 text-slate-400">No challenges match &quot;{languageQuery}&quot;.</p>}
