  ...
  en: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'No. Every learning path starts from the absolute basics, and "Programming Basics: Your First Steps" needs no prior experience at all.',
        },
        {
        ...
        },
        {
          ...
          a: 'No. There are no accounts at all, every course, lesson, quiz, and challenge is open the moment the page loads.',
        },
        {
          q: 'Where should I start if I have never programmed?',
          a: '"Programming Basics: Your First Steps" assumes nothing, it covers variables, data types, conditionals, and loops, and ends with the classic FizzBuzz exercise.',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'They are written to be read in order, but nothing is locked, jump straight to the lesson you need if you already know the earlier material.',
        },
        {
          q: 'What’s actually in a lesson?',
          a: 'Written content with runnable, in-browser code playgrounds for supported languages, sometimes a video, sometimes a quiz, and for some final lessons, a project brief to build on your own machine.',
        },
        {
          q: 'How are quizzes graded, and what’s the passing score?',
          a: 'Quizzes are graded in your browser the moment you submit, most require 70% to pass. If you don’t pass, you can retry immediately and as many times as you like.',
        },
        {
          q: 'Is my progress saved?',
          a: 'No. There is no account and nothing is stored about you, so a quiz result or a piece of code you wrote lives only until you reload the page. Bookmark the lesson you stopped at.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          a: 'Challenges are standalone, bite-sized coding problems, not tied to a specific course, and your solution is run against the test cases the moment you press "Run all tests".',
        },
        {
        ...
        },
        {
          ...
          a: 'The expected outputs ship with the page, so yes, if you go looking in the source you can find them. There is no score to protect here, the challenges are for practice, not assessment.',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Python runs on Pyodide (CPython compiled to WebAssembly), JavaScript in a Web Worker with a timeout, TypeScript is stripped to JavaScript with Sucrase, Lua runs on wasmoon, C on a WebAssembly build of picoc, and HTML renders in a sandboxed iframe. Nothing you write ever leaves your machine.',
        },
        {
  ...
  sv: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Nej. Alla kunskapsstigar börjar från grunden, och "Programming Basics: Your First Steps" kräver ingen tidigare erfarenhet alls.',
        },
        {
        ...
        },
        {
          ...
          a: 'Nej. Det finns inga konton alls, varje kurs, lektion, quiz och utmaning är öppen så fort sidan laddats.',
        },
        {
          q: 'Var börjar jag om jag aldrig programmerat?',
          a: '"Programming Basics: Your First Steps" förutsätter ingenting. Den går igenom variabler, datatyper, villkor och loopar, och avslutas med den klassiska FizzBuzz-övningen.',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'De är skrivna för att läsas i ordning, men ingenting är låst. Hoppa direkt till den lektion du behöver om du redan kan det tidigare materialet.',
        },
        {
          q: 'Vad ingår egentligen i en lektion?',
          a: 'Skriftligt innehåll med körbara kodexempel direkt i webbläsaren för språk som stöds, ibland en video, ibland ett quiz, och för vissa avslutande lektioner en projektbeskrivning du bygger på egen hand.',
        },
        {
          q: 'Hur rättas quiz, och vad krävs för att klara det?',
          a: 'Quiz rättas i din webbläsare direkt när du skickar in dina svar, och de flesta kräver 70 procent rätt för att klara. Klarar du inte quizet kan du försöka igen direkt, så många gånger du vill.',
        },
        {
          q: 'Sparas mina framsteg?',
          a: 'Nej. Det finns inget konto och ingenting lagras om dig, så ett quizresultat eller kod du skrivit lever bara tills du laddar om sidan. Bokmärk lektionen du stannade på.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          a: 'Utmaningar är fristående, mindre kodproblem som inte hör till någon specifik kurs. Din lösning körs mot testfallen så fort du trycker på "Run all tests".',
        },
        {
        ...
        {
          q: 'Kan jag se facit?',
          a: 'De förväntade svaren följer med sidan, så ja, letar du i källkoden hittar du dem. Det finns inget resultat att skydda här, utmaningarna finns för övningens skull, inte för bedömning.',
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          q: 'Hur kan koden köras utan en server?',
          a: 'Python körs på Pyodide (CPython kompilerat till WebAssembly), JavaScript i en Web Worker med tidsgräns, TypeScript görs om till JavaScript med Sucrase, Lua körs på wasmoon, C på en WebAssembly-version av picoc, och HTML renderas i en sandlåde-iframe. Ingenting du skriver lämnar din dator.',
        },
        {
...
export const pageText = {
  en: {
    ...
    intro: 'Answers to the most common questions about learning on Kodstigen. Can’t find what you’re looking for?',
    introLink: 'Get in touch',
  },
  sv: {
    metaTitle: 'Vanliga frågor | Kodstigen',
    metaDescription:
      'Svar på vanliga frågor om att lära sig på Kodstigen: pris, hur kurser och quiz fungerar, kodutmaningar och hur koden körs i din webbläsare.',
    back: '← Till startsidan',
    heading: 'Vanliga frågor',
    intro: 'Svar på de vanligaste frågorna om att lära sig på Kodstigen. Hittar du inte det du letar efter?',
